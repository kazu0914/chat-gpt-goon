...
const redirectToGPT4 = () => {
  if (window.location.href === 'https://chat.openai.com') {
...
sampleButton.addEventListener('click', () => {
  const xpath = '//*[@id="__next"]/div[2]/div[2]/div/main/div[3]/form/div/div[2]/textarea';
...
const newChatObserver = new MutationObserver((mutations) => {
  mutations.forEach((mutation) => {
    if (mutation.type === 'childList') {
      ...
      const newChatButtonXPath = '//*[@id="__next"]/div[2]/div[1]/div/div/div/nav/a';
